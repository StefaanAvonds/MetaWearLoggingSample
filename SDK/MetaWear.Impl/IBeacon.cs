...
namespace MbientLab.MetaWear.Impl {
    ...
    class IBeacon : ModuleImplBase, IIBeacon {
        ...
        public Task<Configuration> ReadConfigAsync() {
            ...
            readConfigTimeout = new Timer(e => readConfigTask.SetException(new TimeoutException("Reading ibeacon config timedout")), null, 7 * MetaWearBoard.COMMS_TIMEOUT, Timeout.Infinite);
