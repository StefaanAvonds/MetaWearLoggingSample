...
namespace MbientLab.MetaWear.Impl {
    ...
    class Settings : ModuleImplBase, ISettings {
        ...
        public Task<BleAdvertisementConfig> ReadBleAdConfigAsync() {
            ...
            adConfigReadTimeout = new Timer(e => adConfigTask.SetException(new TimeoutException("Timed out reading advertising config ")), null, 4 * MetaWearBoard.COMMS_TIMEOUT, Timeout.Infinite);
        ...
        public Task<BleConnectionParameters> ReadBleConnParamsAsync() {
            if (bridge.lookupModuleInfo(SETTINGS).revision >= CONN_PARAMS_REVISION) {
                ...
                connParamsReadTimeout = new Timer(e => adConfigTask.SetException(new TimeoutException("Timed out reading connection parameters")), null, MetaWearBoard.COMMS_TIMEOUT, Timeout.Infinite);
